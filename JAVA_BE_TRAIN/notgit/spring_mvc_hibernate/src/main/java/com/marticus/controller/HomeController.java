...
public class HomeController {
	...
	public String updateUserForDisplay(@PathVariable("Id")String Id, Model model) throws Exception
    {
		Session session = HibernateUtil.getSessionFactory().openSession();
		session.beginTransaction();
	...
	public String usersList(Model model) {
		...
		for (Iterator iterator2 =((java.util.List) Users).iterator(); iterator2.hasNext();){
